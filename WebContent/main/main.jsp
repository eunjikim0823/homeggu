  	...
  	<!-- 헤더영역------------------------------------------------- -->
	    	...
	    	<div class="container">
				<ul class="nav nav-tabs col-md-8 col-sm-8">
					<li class="icon"><a href="Main.html"><img src="../picture/home.png" class="img-rounded img-responsive" width="50" height="50"></a></li>
					<li class="contents"><h2><a href="../Contents/Contents_Board.html">홈꾸집들이 컨텐츠</a></h2></li>
					<li class="free_board"><h2><a href="freeBoard.html">커뮤니티</a></h2></li>
					<li class="store"><h2><a href="index.html">스토어</a></h2></li>
			   	</ul>	
			   		 <!--검색창-->
	...
	<div id="item_content"> 
		...
		<div class="item_container">
			<div class="col-md-12 col-sm-12">
	   	  ...
	   	  <div class="Slidewrap_sale col-md-12 col-sm-12">
