...
String[] name = {"두꺼운 고품질 라텍스 메모리폼 양면 침대 매트리스 ", "[단독특가] 파인 LED 빅수납 헤드 수납침대 SS/Q", "소놉스 LED 리노 평상서랍 침대 (SS/Q) [매트 무료", "아너스 LED 스탠다드 일반/서랍 침대 SS/Q [매트 무", "블랑 옷장/서랍장/화장대/장롱 모음", "틸러 3인용 수납 소파베드", "호텔식 프리미엄급 브릴리언트 매트리스 시리즈", "클린스틱 초강력 BLDC 무선 핸디 청소기", "아델라 거실장 시리즈 협탁/1200/1800/2400"};
